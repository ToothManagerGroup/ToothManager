...
#define kIncomeContenColor RGBColor(249, 0, 62)
#define kStayIncomeContenColor MainColor
...
- (void)setupHeaderView {
    ...
    incomeLabel.textColor = kIncomeContenColor;
    ...
    stayIncomeLabel.textColor = kStayIncomeContenColor;
